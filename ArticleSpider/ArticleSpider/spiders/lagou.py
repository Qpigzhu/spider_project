...
from ArticleSpider.items import LogoArticleItemLoader,LgGouArticleItem

"""
使用CrawlSpider模板爬取全站拉钩网
"""
class LagouSpider(CrawlSpider):
    ...
    def parse_job(self, response):
        ...
        item_loader = LogoArticleItemLoader(item=LgGouArticleItem(),response=response)
        ...
        item_loader.add_value("crawl_time", datetime.now().date())
